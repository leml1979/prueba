...
class ResetPassword extends ResetPasswordNotification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Sundde, se solicitó un restablecimiento de contraseña para tu cuenta ' . $notifiable->getEmailForPasswordReset() . ', haz clic en el botón que aparece a continuación para cambiar tu contraseña.'))
