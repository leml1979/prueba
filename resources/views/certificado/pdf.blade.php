...
<body>
  ...
  <main>
    ...
    <p class="text-justify">Quien suscribe, ENEIDA LAYA LUGO, titular de la cédula de identidad N° V-11.366.874, actuando en mi carácter de SUPERINTENDENTE NACIONAL PARA LA DEFENSA DE LOS DERECHOS SOCIO ECONÓMICOS, designación efectuada mediante Decreto N° 4.016 de fecha 29 de Octubre de 2019, publicado en la Gaceta Oficial de la República Bolivariana de Venezuela Nº 41.748, de fecha 29 de Octubre de 2019; por medio del presente instrumento, actuando de conformidad con la atribución prevista en el artículo 11, numeral 10 del Decreto con Rango, Valor y Fuerza de Ley Orgánica de Precios Justos, certifica la inscripción ante el Registro Único de Personas que Desarrollan Actividades Económicas del Sujeto de Aplicación <b> {!! mb_strtoupper($sujeto->sujeto,"UTF-8") !!}</b> con el RIF <b>{!! $sujeto->rif !!}</b> en fecha {!! $sujeto->registro_dia_sundde."-".$sujeto->registro_mes_sundde."-".$sujeto->registro_anio_sundde !!} con el certicado Nº <b>{!! $sujeto->codigo_certificado !!}</b>, que desarrolla las siguiente acividad economica principal <b>{!! $sujeto->clase->clase !!}</b>.</p>
