		...
		<div class="col-md-10">
			<div class="card bg-white">
				<div class="card-body">
					...
					{!! Form::model($producto,['route' => array('productos.update',$producto->id), 'method' => 'put','id'=>'productos-form']) !!}
					...
					<div class="form-group col-md-6">
						...
						{!! Form::select('categoria', $categorias, $producto->categoria_id, ["class"=>"form-control select2"]); !!}
