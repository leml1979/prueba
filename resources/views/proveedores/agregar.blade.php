			...
			<div class="card bg-white">
				<div class="card-body">
					<div class="row" id="nacional">
						...
						<div class="col-md-12" id="datos_proveedor" style="margin-bottom: 4%">
							<fieldset class="fieldset-collapse">
						...
						<div class="info-box">
							<div class="info-box-content">
								<div class="content">
									<div class="col-md-12">
										<fieldset class="fieldset-collapse">
											<legend><span class="fa fa-check">Datos de Proveedor Extranjero</span></legend>
											<div class="row">
					...
					<button type="submit" class="btn btn-primary col-md-1" id="btn-guardar"><span class="fa fa-save"></span>Guardar</button>
