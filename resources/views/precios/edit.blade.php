		...
		<div class="col-md-10">
			<div class="card bg-white">
				<div class="card-body">
					...
					{!! Form::model($precio,['route' => array('precios.update',$precio->id), 'method' => 'put','id'=>'precios-form']) !!}
					...
					<div class="form-group col-md-6">
						...
						{!! Form::select('producto', $productos, $precio->producto_id,["class"=>"form-control select2"]); !!}
